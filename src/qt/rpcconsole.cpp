...
void RPCConsole::setClientModel(ClientModel* model)
{
    ...
    if (model) {
        ...
        // ui->dataDir->setText(model->dataDir()); // TODO @Voytek
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BEAR RPC console.") + "<br>" +
...
void RPCConsole::setNumBlocks(int count)
{
    ...
    if (clientModel) {
		...
		// ui->lastBlockHash->setText(clientModel->getLastBlockHash()); // TODO @Voytek
	}
}
