...
// Copyright (c) 2015-2018 The BEAR Coin developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BEAR Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BEAR address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BEAR: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BEAR Core"), this);
    aboutAction->setStatusTip(tr("Show information about BEAR Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BEAR"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BEAR addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BEAR addresses"));
    ...
    openAction->setStatusTip(tr("Open a BEAR: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/editpaste"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BEAR Core help message to get a list with possible BEAR command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BEAR Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BEAR network", "", count));
}
...
{
    QString strTitle = tr("BEAR Core"); // default title
