                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received BEAR from zBEAR"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zBEAR"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zBEAR));
