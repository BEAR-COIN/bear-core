...
/** 
    ...
    ****Note - for BEAR we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of bear coming in to a transaction
