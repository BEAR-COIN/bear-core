...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BEAR features */
        {"bear", "masternode", &masternode, true, true, false},
        {"bear", "listmasternodes", &listmasternodes, true, true, false},
        {"bear", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bear", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bear", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bear", "masternodedebug", &masternodedebug, true, true, false},
        {"bear", "startmasternode", &startmasternode, true, true, false},
        {"bear", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bear", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bear", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bear", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bear", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bear", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bear", "mnsync", &mnsync, true, true, false},
        {"hidden", "spork", &spork, true, true, false},
        {"bear", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use beard, or the -server option to bear-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bear-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8181/\n";
}
