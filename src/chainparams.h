 ...
 * BEAR system. There are three: the main network on which people trade goods
...
public:
    ...
    /** PublicFund **/
    std::string publicFundAddress;
    CAmount publicFundReward;
    int publicFundStart;
    std::string PublicFundAddress() const { return publicFundAddress; }
    CAmount PublicFundReward() const { return publicFundReward; }
    int PublicFundStart() const { return publicFundStart; }
