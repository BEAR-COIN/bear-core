Contributing to BEAR Core
============================

The BEAR Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BEAR Core project, and is not to be
confused with overall BEAR Network Protocol consensus changes.

Whether a pull request is merged into BEAR Core rests with the project merge
...
Patches that change BEAR consensus rules are considerably more involved than
...
Where a patch set proposes to change the BEAR consensus, it must have been
...
The project leader is the release manager for each BEAR Core release.
