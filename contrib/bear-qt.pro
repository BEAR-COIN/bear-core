...
RESOURCES += src/qt/bear.qrc src/qt/bear_locale.qrc

TRANSLATIONS += src/qt/locale/bear_bg.ts \
                src/qt/locale/bear_de.ts \
                src/qt/locale/bear_en.ts \
                src/qt/locale/bear_es.ts \
                src/qt/locale/bear_fi.ts \
                src/qt/locale/bear_fr.ts \
                src/qt/locale/bear_it.ts \
                src/qt/locale/bear_ja.ts \
                src/qt/locale/bear_pl.ts \
                src/qt/locale/bear_pt.ts \
                src/qt/locale/bear_ru.ts \
                src/qt/locale/bear_sk.ts \
                src/qt/locale/bear_sv.ts \
                src/qt/locale/bear_vi.ts \
                src/qt/locale/bear_zh_CN.ts \
                src/qt/locale/bear_zh_TW.ts
